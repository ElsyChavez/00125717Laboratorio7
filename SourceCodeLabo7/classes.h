...
enum parameters {CONST_TAU, CONST_KAPPA, CONST_LAMBDA, CONST_X, CONST_Y, CONST_DELTA, CONST_ETA};
...
class mesh{
    ...
    public:
        void setParameters(float tau,float kappa, float lambda, float f_x, float f_y, float delta, float eta){
            parameters[CONST_TAU]=tau;
            parameters[CONST_KAPPA]=kappa;
            parameters[CONST_LAMBDA]=lambda;
            parameters[CONST_X]=f_x;
            parameters[CONST_Y]=f_y;
